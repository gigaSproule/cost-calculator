...
fn how_much_to_charge() -> gtk4::Grid {
    ...
    calculate.connect_clicked(
        clone!(@strong minutes_input, @strong material_costs_container, @strong material_costs_container_rows, @strong cost_of_delivery_input, @strong offsite_ads_used_input, @strong answer_label =>
            move |_| {
